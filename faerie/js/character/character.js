(function (window) {
    ...
    faerie.prototype = {
        init: function () {
            //add sound
            this.sound_playAttack = this.game.add.audio('playerAttack');
            this.sound_playAttack.allowMultiple = true;
            //init faerie
    ...
    pumpkin.prototype = enemy.prototype;
    pumpkin.prototype.init = function () {
        this.TYPE = "PUMPKIN";
    ...
    pumpkin.prototype.move = function () {
    ...
    pumpkin.prototype.kill = function(){
        //explode animation
    ...
    pumpkin.prototype.clone = function(){
